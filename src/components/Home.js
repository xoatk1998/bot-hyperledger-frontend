                        ...
                        <div className="col-7 s1-left">
                            <div className="s1-text">
                                <div className="s1-text-title">
                                    <span id="s1-span">BOT automatic service</span>
                                    <p id="s1-p">Transparent and public BOT system applying blockchain, leading to 4.0 era.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="s4-icon" className=" s3 justify-content-center">
                            <div className="h-25 row justify-content-center sl">
                                <div className="col-sm-3 h-100">
                                    ...
                                    <p className="s7-2-1">Users regigtered</p>
                                </div>
                                <div className="col-sm-3 h-100">
                                    ...
                                    <p className="s7-1-2">3450</p>
                                    <p className="s7-2-2">Wallet connected</p>
                                </div>
                                <div className="col-sm-3 h-100">
                                    <svg className="s7-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" version="1.0" fit=""
                                        height="100px" width="100px" preserveAspectRatio="xMidYMid meet"
                                    ...
                                    <p className="s7-2-3">BOT cooperated</p>
                                </div>
                                <div className="col-sm-3 h-100">
                                    <svg className="s7-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" version="1.0" fit=""
                                        height="100px" width="100px" preserveAspectRatio="xMidYMid meet"
                                    ...
                                    <p className="s7-2-4">Statistic made</p>
                                </div>
                            </div>
                        </div>
                    </div>
